    ...
    <motion.div layout initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.97 }}
      ...
      <div className="flex flex-col items-center gap-4 px-4 py-5"
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 w-full pt-1">
          {order.paymentMethod && (
            <span className="inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-[11px] font-bold uppercase tracking-wide whitespace-nowrap text-white shadow-sm shrink-0"
